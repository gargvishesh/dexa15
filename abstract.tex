...
In this paper, we address the pragmatic goal of minimally altering current implementations of database operators to make them PCM-conscious - the objective being to facilitate an early transition to the new technology. Specifically, we target implementations of ``workhorse'' database operators: \emph{sort},
...
These techniques are evaluated on \emph{end-to-end} TPC-H benchmark queries with regard to writes, response time and wear distributions metrics. Our experimental results
indicate that the PCM-conscious operators collectively reduce the number
